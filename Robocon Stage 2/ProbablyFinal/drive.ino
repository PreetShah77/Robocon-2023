...
void Forward(int pwm) {
  ...
  analogWrite(M4_pwm, (pwm - abs(6 * pwm / 255)));
  analogWrite(M1_pwm, (pwm - abs(6 * pwm / 255)));
  analogWrite(M2_pwm, (pwm - abs(6 * pwm / 255)));
...
void Right(int pwm) {
  ...
  analogWrite(M4_pwm, (pwm - abs(6 * pwm / 255)));
  analogWrite(M1_pwm, (pwm - abs(6 * pwm / 255)));
  analogWrite(M2_pwm, (pwm - abs(8 * pwm / 255)));
  analogWrite(M3_pwm, (pwm - abs(15 * pwm / 255)));
}
